...
namespace CommonFrameWork.ToolKit
{
    /// <summary>
    /// 加密解密
    /// </summary>
    public class Encrypt
    {
        ...
        //{
        //    return MD5Encrypt(str, Encoding.UTF8);
        //}
        ...
        public static string MD5Encrypt(string pwd, Encoding encoding)
        {
        ...
        #region AES 加密/解密：Rijndael是AES的实现
        /// <summary>
        /// 生成 AES 的 16 个字符的密钥
        /// </summary>
        /// <returns>密钥</returns>
        //public static string GetKeyAES16()
        //{
        //    return "@HarborHouseHome"; //StringHelper.GetRnd(16, true, true, true, true, "");
        //}
        /// <summary>
        /// 生成 AES 的 32 个字符的密钥
        /// </summary>
        /// <returns>密钥</returns>
        //public static string GetKeyAES32()
        //{
        //    return StringHelper.GetRnd(32, true, true, true, true, "");
        //}

        /// <summary>
        /// AES 加密
        /// </summary>
        /// <param name="toEncrypt">要加密的信息</param>
        /// <param name="key">key必须是 16,32个字符，分别对应128，256位密钥</param>
        ...
        public static string AESEncrypt(string toEncrypt, string key)
        {
            ...
            ICryptoTransform aesTransform = aesm.CreateEncryptor();
            byte[] resultArray = aesTransform.TransformFinalBlock(toEncryptArray, 0, toEncryptArray.Length);
        ...
        /// AES 解密
        /// </summary>
        /// <param name="toDecrypt">要解密的信息</param>
        /// <param name="key">key必须是 16,32个字符，分别对应128，256位密钥</param>
        /// <returns>string</returns>
        public static string AESDecrypt(string toDecrypt, string key)
        {
            try
            {
                ...
                ICryptoTransform aesTransform = aesm.CreateDecryptor();
                byte[] resultArray = aesTransform.TransformFinalBlock(toEncryptArray, 0, toEncryptArray.Length);
        ...
        public static void GetKeyRSA(out string xmlKeys, out string xmlPublicKey)
        {
        ...
        public static bool GetHash(string m_strSource, ref byte[] HashData)
        {
            ...
            Buffer = UTF8Encoding.UTF8.GetBytes(m_strSource);
