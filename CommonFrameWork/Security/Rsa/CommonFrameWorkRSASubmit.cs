...
namespace CommonFrameWork.Security.Rsa
{
    ...
    /// </summary>
    public class CommonFrameWorkRsaSubmit
    {
        #region 字段
        //支付宝网关地址（新）
        ...
        public CommonFrameWorkRsaSubmit(string gateway, string private_key, string input_charset, string sign_type)
        {
            _gateway = gateway;
        ...
        private  string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            string prestr = CommonFrameWorkRsaCore.CreateLinkString(sPara);
            ...
            {
                case "RSA":
                    mysign = CommonFrameWorkRsa.Sign(prestr, _private_key, _input_charset);
                    break;
                default:
                    mysign = "";
                    break;
        ...
        private  Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //过滤签名参数数组
            sPara = CommonFrameWorkRsaCore.FilterPara(sParaTemp);
        ...
        private  string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = CommonFrameWorkRsaCore.CreateLinkStringUrlencode(sPara, code);
        ...
        //{
        //    string url = _gateway + "service=query_timestamp&partner=" + partner + "&_input_charset=" +this._input_charset;
        //    string encrypt_key = "";
