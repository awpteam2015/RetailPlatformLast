...
namespace CommonFrameWork.Security.Rsa
{
    ...
    /// </summary>
    public class CommonFrameWorkRsaNotify
    {
        #region 字段
        ...
        public CommonFrameWorkRsaNotify(string partner, string alipay_public_key, string input_charset, string sign_type)
        {
            //初始化基础配置信息
            _partner = partner.Trim();
            alipay_public_key = alipay_public_key.Trim();
        ...
        private string GetPreSignStr(SortedDictionary<string, string> inputPara)
        {
            ...
            sPara = CommonFrameWorkRsaCore.FilterPara(inputPara);

            //获取待签名字符串
            string preSignStr = CommonFrameWorkRsaCore.CreateLinkString(sPara);
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "RSA":
                        isSgin = CommonFrameWorkRsa.Verify(preSignStr, sign, alipay_public_key, _input_charset);
                        break;
                    default:
                        break;
                }
