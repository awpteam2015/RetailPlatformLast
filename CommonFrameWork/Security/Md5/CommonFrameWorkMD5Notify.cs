...
namespace CommonFrameWork.Security.Md5
{
    ...
    /// </summary>
    public class CommonFrameWorkMd5Notify
    {
        #region 字段
        ...
        public CommonFrameWorkMd5Notify(string partner, string key, string input_charset, string sign_type)
        {
            //初始化基础配置信息
        ...
        private string GetPreSignStr(SortedDictionary<string, string> inputPara)
        {
            ...
            sPara = CommonFrameWorkMd5Core.FilterPara(inputPara);

            //获取待签名字符串
            string preSignStr = CommonFrameWorkMd5Core.CreateLinkString(sPara);
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "MD5":
                        isSgin = CommonFrameWorkMd5.Verify(preSignStr, sign, _key, _input_charset);
                        break;
                    default:
                        break;
                }
