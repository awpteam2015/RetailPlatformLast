...
namespace CommonFrameWork.Security.Md5
{
    /// <summary>
    /// 类名：Submit
    /// 功能：支付宝各接口请求提交类
    ...
    /// </summary>
    public class CommonFrameWorkMd5Submit
    {
        #region 字段
        ...
        public CommonFrameWorkMd5Submit(string gateway,  string key, string input_charset, string sign_type)
        {
            _gateway = gateway;
            _key = key.Trim();
        ...
        public CommonFrameWorkMd5Submit(string gateway)
        {
            _gateway = gateway;
        ...
        private  string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            string prestr = CommonFrameWorkMd5Core.CreateLinkString(sPara);
            ...
            {
                case "MD5":
                    mysign = CommonFrameWorkMd5.Sign(prestr, _key, _input_charset);
                    break;
                default:
                    mysign = "";
                    break;
        ...
        private  Dictionary<string, string> BuildRequestPara(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //过滤签名参数数组
            sPara = CommonFrameWorkMd5Core.FilterPara(sParaTemp);
        ...
        private  string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            string strRequestData = CommonFrameWorkMd5Core.CreateLinkStringUrlencode(sPara, code);
